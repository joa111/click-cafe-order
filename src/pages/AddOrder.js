...
const AddOrderForm = ({ onOrderAdded = () => { } }) => {
  ...
  return (
    <div className="min-h-screen bg-brand-gray p-4 flex items-center justify-center">
      <div className="max-w-4xl w-full bg-white border border-gray-200 shadow-sm relative flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-96 bg-gray-50 p-8 flex flex-col h-full border-t md:border-t-0 md:border-l border-gray-200">
